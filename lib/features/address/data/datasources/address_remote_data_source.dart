    ...
    try {
      ...
      if (address.isDefault) {
        await supabaseClient
            ...
            .eq('user_id', userId); // Use the authenticated userId
      }

      // Create address model with user ID (id will be auto-generated by Supabase)
      final addressModel = UserAddressModel(
        id: '', // Will be ignored, Supabase generates it
        userId: userId,
        name: address.name,
      ...
      // Convert to JSON but exclude id (let Supabase generate it)
      final jsonData = addressModel.toJson();
      jsonData.remove('id'); // Remove id so Supabase auto-generates it
